...
for i=1:size(f_b,2)-1
    ...
    delta_L = V_n(1,i)/(P(3,i)+RN(i));
    delta_l = V_n(2,i)/(P(3,i)+RE(i))/cos(P(1,i));
    delta_h = -V_n(3,i);
...
%     delta_qC(:,:,i) = qC(:,:,i)*Omega_b_ib - Omega_n_in*qC(:,:,i);
    ...
    surf_r = R_surface(Earth_R_long, Earth_R_short, P(1,i)) + P(3,i);
    r = [surf_r*cos(P(1,i))*cos(P(2,i)), surf_r*cos(P(1,i))*sin(P(2,i)), surf_r*sin(P(1,i))]';
    %g0 = 9.7803253359*(1+0.001931853*sin(P(1,i))^2z)/sqrt(1-(e*sin(P(1,i)))^2);
